...
const Subjects = () => {
    ...
    const fetchSubjects = async () => {
        ...
        try {
            const { data } = await apiClient.get('/api/subjects', config);
            setSubjects(data);
        } catch (error) {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            const { data } = await apiClient.post('/api/subjects', formData, config);
    ...
    const deleteSubject = async (id) => {
        ...
        try {
            await apiClient.delete(`/api/subjects/${id}`, config);
